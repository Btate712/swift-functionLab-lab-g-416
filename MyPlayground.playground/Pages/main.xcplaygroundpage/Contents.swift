 ...
 */
func printSomeConstant() {
    let someConstant = "Random words..."
    print("My constant is \"\(someConstant)\".")
}
/*: question3
 ...
 */
func printSomeVariables() {
    var word = "Hello"
    print(word)
    var differentVariable = word
